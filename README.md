...
Analizador de un lenguaje personalizado de definición de usuarios implementado con **ANTLR4** y **JavaScript (Node.js)** [1, 2]. El analizador cumple con las fases fundamentales del proceso de traducción y realiza las siguientes tareas [1]:

| Fase/Tarea | Descripción |
| :--- | :--- |
| **1. Análisis léxico y sintáctico** | Informa si la entrada es correcta o contiene errores, indicando la línea y causa exacta [2]. |
| **2. Tabla de lexemas/tokens** | Muestra todos los lexemas reconocidos con su tipo de token, línea y columna [2]. |
| **3. Árbol de análisis sintáctico** | Construye y muestra el árbol sintáctico concreto en formato de texto estructurado estilo ANTLR (LISP) [1, 2]. |
| **4. Interpretación** | Traduce el código de usuarios a JavaScript equivalente y lo ejecuta como un intérprete básico [1, 2]. |

---

## ⚙️ Gramática Implementada (`Usuario.g4`)
El analizador reconoce estructuras de bloques de usuarios con atributos tipados (cadenas, números y booleanos en español). Un resumen de las reglas principales [3]:
...
--------------------------------------------------------------------------------
🚀 Requisitos Previos
No se requiere Java para ejecutar este proyecto, ya que el lexer y el parser están implementados directamente en JavaScript y utilizan la librería antlr4 de npm solo como runtime de soporte
. Solo se necesita:
